...
demographics[,":="(pct_unemployed = unemployed / total_pop
)]

demographics[,list(county, pct_unemployed)]
```

Ok, so you found a few "black box" metrics that retrospectively correlate (although obviously don't prove or predict) the outcome. Seems you've fallen into the same trap of retrospective bias that you accuse others of. If you were so confident of your predictions, why weren't you advertising them before the election? At least others put their money where their mouths were.